...
namespace Condemned.CondemnedCode.Cards;
...
/// </summary>
[Pool(typeof(CondemnedCardPool))]
public abstract class CondemnedCard(int cost, CardType type, CardRarity rarity, TargetType target) :
    ConstructedCardModel(cost, type, rarity, target)
{
    ...
    protected List<string> UsableCardKeywords =
    [
        "Exhaust", "Ethereal", "Unplayable", "Retain", "Cursed", "Foretell", "Looping", "Sleight", "Recharge", "Replay"
    ];
}